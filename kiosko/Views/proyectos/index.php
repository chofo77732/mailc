...
$id_s=$_SESSION['id'];
$query = "SELECT * FROM `proyecto` where fk_perfil='$id_s'";
            ...
            while($registro = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                ...
                echo "<tr>
                        ...
                        <td>".$registro['tipo']."</td>
                         ...
                         <td>
                         <img class='img-responsive ' src=\"ver.php?id=".$registro['id_proyecto']."\" width='150' height='100' ></td>

                         <td>".$registro['area']."</td>
                    

 <td><a href='javascript:modificar(".$registro['id_proyecto'].");' class='glyphicon glyphicon-edit'>Editar</a>
                      
                         <a href='javascript:eliminar(".$registro['id_proyecto'].");' class='glyphicon glyphicon-remove-circle'>Eliminar</a>

                         <a href='../grupos/crearGrupo.php?id_proyecto=".$registro['id_proyecto']."' >Crear Grupo</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="alert alert-success text-center" id="exito" style="display:none;">
                  <span class="glyphicon glyphicon-ok"> </span><span>Proyecto Registrado</span>
                </div>
...
<div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="area" class="control-label col-xs-4">Area:</label>
                    <div class="col-xs-6">
                        <input id="area" name="area" type="text" class="form-control" required autocomplete="off">
...
function modificar(id){
    //$('#responsive')[0].reset();
     var url = '../../Controllers/proyecto.php';
        $.ajax({
        type:'POST',
        url:url,
